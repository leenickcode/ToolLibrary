...
//		super.onWindowFocusChanged(hasFocus);
     ...
     * @return
     */
    public static ProgressLoadingDialog show(Context context, CharSequence message, boolean cancelable, OnCancelListener cancelListener) {
        ProgressLoadingDialog dialog = new ProgressLoadingDialog(context, R.style.Progress_loading);
        dialog.setTitle("");
